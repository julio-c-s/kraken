...
Feature: Iniciar una conversacion
...
Scenario: Como primer usuario inicio sesion y mandó un mensaje al usuario 2 
    ...
    And I wait for a signal containing "login2 complete" for 30 seconds
    And I wait for 2 seconds
    And I click on the first conversation
    And I wait for 5 seconds
    And I click on the redact message inputbox
    And I wait for 2 seconds
    And I enter text "Usuario 1 esta usando esto"
    And I wait for 2 seconds
...
Scenario: Como usuario 2 inicio sesion y mandó un mensaje al usuario 1
    ...
    And I wait for 7 seconds
    And I wait for a signal containing "login1 complete" for 30 seconds
    And I click next
    And I wait for 7 seconds
    ...
    And I click on the redact message inputbox
    And I wait for 2 seconds
    And I enter text "Usuario 2 responde"
    And I wait for 2 seconds
    And I send the message
    And I wait for 2 seconds
